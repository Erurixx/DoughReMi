        ...
        { 
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand(query, connection))
                {
                    ...
                    command.Parameters.AddWithValue("@ansQ1", ansQ1.Text);
                    ...
                    command.Parameters.AddWithValue("@ansQ2", ansQ2.Text);
                    ...
                    command.Parameters.AddWithValue("@ansQ3", ansQ3.Text);
                    ...
                    command.Parameters.AddWithValue("@ansQ4", ansQ4.Text);
                    ...
                    command.Parameters.AddWithValue("@ansQ5", ansQ5.Text);
